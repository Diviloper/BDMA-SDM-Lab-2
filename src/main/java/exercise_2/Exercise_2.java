    ...
    private static class sendMsg extends AbstractFunction1<EdgeTriplet<Integer, Integer>, Iterator<Tuple2<Object, Integer>>> implements Serializable {
        ...
        public Iterator<Tuple2<Object, Integer>> apply(EdgeTriplet<Integer, Integer> triplet) {
            ...
            if (sourceVertex._2 < Integer.MAX_VALUE && sourceVertex._2 + triplet.attr < dstVertex._2) {
                return JavaConverters.asScalaIteratorConverter(Collections.singletonList(new Tuple2<Object, Integer>(triplet.dstId(), sourceVertex._2 + triplet.attr)).iterator()).asScala();
            } else {
